...
searchCtrl.controller('searchBar', ['$scope', '$http', function($scope, $http) {
  ...
  $scope.submitSearch = function() {
    $http.get('https://api.betterdoctor.com/2016-03-01/doctors?location=37.773%2C-122.413%2C100&user_location=37.773%2C-122.413&sort=rating-desc&skip=0&limit=3&user_key=c77db2625ba3d0debf3e9be3b74158bd').success(function(data) {
      console.log(data.data);
